...
async def main():
    ...
    # Webhook sozlash (agar RENDER_EXTERNAL_HOSTNAME mavjud bo'lsa)
    ...
    if RENDER_EXTERNAL_HOSTNAME:
        ...
        print("WARNING: RENDER_EXTERNAL_HOSTNAME topilmadi – webhooksiz ishlaydi, lekin bot javob bermasligi mumkin.")
